  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        socialLinksData.map((item) => {
          ...
          return (
            <a
              ...
              aria-label={label}
            >
              <span className="text-sm font-medium text-vision-900">{label}</span>
      ...
      <button
        ...
        aria-label={isOpen ? t("floatingAction.aria.close") : t("floatingAction.aria.open")}
