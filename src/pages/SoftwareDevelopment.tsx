      ...
      <main className="pt-[88px]">
        <section className="relative overflow-hidden text-white">
          ...
          <div className="relative z-10 container mx-auto px-4 py-20">
            ...
            <div className="mt-8">
              <Link to="/#services" className="inline-flex rounded-md bg-vision-tech text-white px-4 py-2 font-medium hover:bg-vision-tech/90 transition-colors">
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {segment.services.map((service, index) => (
              <article key={index} className="bg-white rounded-xl p-6 shadow-md border border-vision-tech/20">
